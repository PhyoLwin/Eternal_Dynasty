...
for ($i = 0; $i < 4; $i++) {
    ...
    $sql1 = "SELECT `bfirst_name` FROM `tue_boy` WHERE `bfirst_name` IS NOT NULL ORDER BY RAND() LIMIT 1";
    $result1 = $conn->query($sql1);

    // Select random bmiddle_double
    $sql2 = "SELECT `bmiddle_double` FROM `tue_boy` WHERE `bmiddle_double` IS NOT NULL ORDER BY RAND() LIMIT 1";
    $result2 = $conn->query($sql2);

    // Select random blast_name
    $sql3 = "SELECT `blast_name` FROM `tue_boy` WHERE `blast_name` IS NOT NULL ORDER BY RAND() LIMIT 1";
...
for ($i = 0; $i < 2; $i++) {
    ...
    $sql2 = "SELECT `bfirst_double` FROM `tue_boy` WHERE `bfirst_double` IS NOT NULL ORDER BY RAND() LIMIT 1";
    $result2 = $conn->query($sql2);
...
for ($i = 0; $i < 1; $i++) {
    ...
    if (!empty($bfirst_name)) {
        $sql3 = "SELECT `blast_name` FROM `tue_boy` WHERE `blast_name` IS NOT NULL 
